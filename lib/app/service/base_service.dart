...
import 'package:mvvm/app/util/util.dart';
  ...
  Future<MyResponse<dynamic, dynamic>> callAPI(
    ...
    try {
      ...
      if (response?.statusCode == HttpStatus.ok ||
        ...
        return MyResponse.success(data: response?.data);
      }
      ...
      if (e.response?.data != null && e.response?.data != '') {
        return MyResponse.error(e,
            error: JsonParsing(e.response?.data).toJson());
      }
      return MyResponse.error(e, error: e.response?.data);
    }
